...
#dc vmware-toolbox-cmd timesync enable
hwclock -w

# Install zabbix repo
#dc wget -O /tmp/zabbix-release_5.0-1+focal_all.deb https://repo.zabbix.com/zabbix/5.0/ubuntu/pool/main/z/zabbix-release/zabbix-release_5.0-1+focal_all.deb
#dc dpkg -i /tmp/zabbix-release_5.0-1+focal_all.deb
...
# Install Eclipse
#dc wget -O /tmp/eclipse.tar.gz "http://mirrors.neusoft.edu.cn/eclipse/technology/epp/downloads/release/2020-12/R/eclipse-cpp-2020-12-R-linux-gtk-x86_64.tar.gz"
#dc tar zxf /tmp/eclipse.tar.gz -C /opt
#dc rm /tmp/eclipse.tar.gz
#dc wget -O /usr/share/pixmaps/eclipse.png "https://icon-icons.com/downloadimage.php?id=94656&root=1381/PNG/64/&file=eclipse_94656.png"
#dc cat - <<EOM > /usr/share/applications/eclipse.desktop
#dc [Desktop Entry]
#dc Name=Eclipse
#dc Exec=/opt/eclipse/eclipse
#dc Type=Application
#dc Icon=eclipse
#dc EOM
